    ...
    <li key={index}>{desc}</li>
            ...
            <div className="flex items-center mt-10 gap-4 text-base">
              ...
              <button
                ...
                className="w-full py-3.5 cursor-pointer font-medium bg-orange-400 text-white hover:bg-orange-500 transition"
              >
                Buy now
              </button>
...
{/* related products ----------- */}
         ...
         <div className="flex flex-col items-center mt-20">
          ...
          <button
            ...
            className="w-1/2 my-8 py-3.5 cursor-pointer font-medium bg-orange-400 text-white hover:bg--orange-500 transition"
          >
            See More
               </button>
             </div>
